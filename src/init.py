...
def init_classifier(cfg):
    ...
    classifier = Matching_VGG(vgg_depth = "VGG16", conv_layer_name=cfg.nn.conv_layer_type, conv_layer_type=conv_layer_types[cfg.nn.conv_layer_type], divisive_sigma=cfg.nn.divisive.sigma, threshold=cfg.nn.threshold)
    return classifier
